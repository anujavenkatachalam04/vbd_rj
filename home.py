...
- **Weekly Trends** (2024 Dengue Season - Jul-Dec) : Weekly Time Series charts for each block within a district. The top 10% of districts/blocks reporting dengue cases are labeled as 'High'.
